...
| **효과**                    | **문제 해결**                                                                                     | **관련 기능**                                                                                                                                              |
|-----------------------------|-------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| **교육 기회 확대**           | 대형 플랫폼의 독점으로 제한된 교육 기회를 보완하여, 프리랜서 강사도 강의를 개설할 수 있는 환경 제공 | 1:1 강의 및 1:N 강의 중개 기능을 통해 다양한 강의 옵션을 탐색하고 적합한 강의를 선택 가능                                                                   |
| **교육 접근성 향상**         | 소비자가 개인 일정과 강의 일정을 비교하며 교육 참여를 계획할 수 있도록 지원                      | 일정 공유 및 관리 기능을 통해 강사와 수강생 간의 소통을 강화하고 캘린더 기반으로 수업 조율 가능                                                              |
| **교육 서비스의 효율적 운영** | 강사와 수강생이 복잡한 절차 없이 간편하게 강의를 관리하고 신청 가능                               | 채팅 기능을 활용하여 커뮤니케이션을 원활히 하고, 결제 기능 및 대기열 기능을 통해 안정적인 강의 신청 및 운영 환경 제공                                         |
| **사용자 경험 개선**         | 사용자 친화적인 인터페이스와 편리한 기능으로 플랫폼 이용의 만족도 향상                            | SMS 일정 리마인드 및 SSE를 활용한 실시간 알림 기능으로 강의 일정, 변경 사항, 결제 상태를 즉시 확인 가능                                                      |
| **교육 다양성과 질 향상**     | 특정 강사 및 콘텐츠 편중 문제를 완화하고 다양한 강의와 강사를 소개                               | 그룹 채팅 기능으로 분반 간 커뮤니티 형성 및 강사와 수강생 간 상호작용 증대                                                                                  |
| **안정적이고 확장 가능한 시스템 제공** | 높은 트래픽 상황에서도 안정적으로 서비스를 제공                                                  | Redis Stream을 통한 데이터 유실 방지 및 확장 가능한 알림 기능으로 안정성과 신뢰성 확보                                                                      |

**SwithT 프로젝트**는 프리랜서 강사와 수강생 모두에게 최적화된 플랫폼 환경을 제공하며, 교육 시장의 다양성과 질적 성장을 동시에 도모합니다.
